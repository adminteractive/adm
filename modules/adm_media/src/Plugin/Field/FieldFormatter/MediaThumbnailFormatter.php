...
/**
 * Plugin implementation of the 'adm_media_thumbnail' formatter.
 *
 * @FieldFormatter(
 *   id = "adm_media_thumbnail",
 *   label = @Translation("ADM Media Thumbnail"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
...
class MediaThumbnailFormatter extends ImageFormatter {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    if ($this->viewMode === '_entity_embed') {
      ...
      $element['#attached']['library'][] = 'adm_media/image-resize';
      ...
      $element['dimensions']['controls'] = [
        '#type' => 'container',
        '#attributes' => [
          'class' => ['adm-media--controls']
        ],
        'reset' => [
          '#type' => 'html_tag',
          '#tag' => 'a',
          '#attributes' => [
            'class' => ['adm-media--reset', 'button'],
      ...
      $element['image_border'] = [
        '#title' => t('Image border'),
        '#type' => 'checkbox',
        '#default_value' => $this->getSetting('image_border'),
      ];
    }
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($media_items as $delta => $media) {
      ...
      if ($this->getSetting('image_border')) {
        $elements[$delta]['#attributes']['class'][] = 'with-border';
      }
